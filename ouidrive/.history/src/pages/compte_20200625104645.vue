    ...
    <div>
      <q-field>
        <template v-slot:control>
          <div class="self-center full-width no-outline" tabindex="0"> {{nom}} </div>
        </template>
      </q-field>
      ...
      <q-field>
        <template v-slot:control>
          <div class="self-center full-width no-outline" tabindex="0">  {{prenom}} </div>
        </template>
      </q-field>
      ...
      <q-field>
        <template v-slot:control>
          <div class="self-center full-width no-outline" tabindex="0">   {{telephone}}  </div>
        </template>
      </q-field>
