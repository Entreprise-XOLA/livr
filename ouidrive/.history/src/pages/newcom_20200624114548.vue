...
export default {
  ...
  methods: {
    ...
    confirmer_commande () {
      ...
      this.$axios.get('http://vps732924.ovh.net/ouidrive/index.php/api_admin/new_reservation/validation?id_clients=1&id_arriver='+this.lieux_arrive+'&jour_depart='+this.date_depart+'&heure_depart='+this.heure_depart)
        .then((response) => {
