<template>
  <div>
    <center>
      <div
        style="background-color:darkslategray;padding-top:5%;padding-bottom:5%;margin-bottom:10px"
      >
        <div class="logo">
          <img
            src="ouiidrive_icon.png"
      ...
      <div class="q-pa-md">
        <div style="padding:10%">
          ...
          <div style="padding:30px;font-weight:600;font-size:16px"> 
pas de compte?
<a  style="text-decoration:none;color:blue" href="newlogin" >  créer un compte </a> 
...
export default {
  ...
  methods: {
    ...
    postLogin() {
      ...
      this.$axios
        .post(
          `http://vps732924.ovh.net/ouidrive/index.php/api_admin/get_login_client`,
          params
        )
        .then(response => {
