...
<br>
<div style="padding-left:10px;padding-right:10px">   <q-btn color="white" style="width:100%" text-color="black" label="Réserver" type="submit" />
           </div>
             </div>
          </q-form>
...
var cat = localStorage.getItem('message');
    ...
    confirmer_commande () {
      this.$axios.get('http://vps732924.ovh.net/ouidrive/index.php/api_admin/new_reservation/validation?id_client='++'&id_arriver='+this.lieux_arrive+'jour_depart='+date_depart+'heure_depart='+heure_depart)
        .then((response) => {
