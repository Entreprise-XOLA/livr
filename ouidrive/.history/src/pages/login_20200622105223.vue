<template>
  <div>
    <center>
    <div style="background-image:url('assets/50-Beautiful-and-Minimalist-Presentation-Backgrounds-031.jpg')">
    <div class="logo">
        <img src="assets/logoXola.png" style="height: 110px; max-width: 150px;margin-top:20px;"/>
    </div>
