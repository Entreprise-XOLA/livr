...
export default {
  ...
  methods: {
    ...
    confirmer_commande() {
      ...
      this.$axios
        .get(
          "http://vps732924.ovh.net/ouidrive/index.php/api_admin/new_reservation/validation?id_client="+id_client+"&id_arriver=" +
            this.lieux_arrive +'&id_depart='+this.lieux_depart +
            "&jour_depart=" +
            this.date_depart +
            "&heure_depart=" +
            this.heure_depart
